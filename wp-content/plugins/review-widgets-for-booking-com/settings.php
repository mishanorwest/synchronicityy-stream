...
{
delete_option($trustindex_pm_booking->get_option_name('review-download-notification'));
...
$tabs[ TrustindexPlugin_booking::___("Free Widget Configurator") ] = "setup_no_reg";
}
else
{
...
{
$tabs[ TrustindexPlugin_booking::___("My Reviews") ] = "my_reviews";
}
$tabs[ TrustindexPlugin_booking::___('Get Reviews') ] = "get_reviews";
$tabs[ TrustindexPlugin_booking::___('Rate Us') ] = "rate";
if(!$trustindex_pm_booking->is_trustindex_connected())
{
$tabs[ TrustindexPlugin_booking::___('Get more Features') ] = "setup_trustindex";
$tabs[ TrustindexPlugin_booking::___('Log In') ] = "setup_trustindex_join";
}
$tabs[ TrustindexPlugin_booking::___('Troubleshooting') ] = "troubleshooting";
...
<p>
<?php echo TrustindexPlugin_booking::___('For some reason, the <strong>CSS</strong> file required to run the plugin was not loaded.<br />One of your plugins is probably causing the problem.'); ?>
</p>
</div>
...
let js_files = [
{
url: '<?php echo $trustindex_pm_booking->get_plugin_file_url('static/js/admin-page-settings-connect.js'); ?>',
id: 'connect'
},
{
url: '<?php echo $trustindex_pm_booking->get_plugin_file_url('static/js/admin-page-settings-common.js'); ?>',
id: 'common'
},
<?php if(in_array($trustindex_pm_booking->shortname, [ 'google', 'facebook' ])): ?>
{
url: '<?php echo $trustindex_pm_booking->get_plugin_file_url('static/js/admin-page-settings.js'); ?>',
id: 'unique'
}
<?php endif; ?>
];
...
element.href = url;
element.id = 'trustindex_settings_style_booking-css';
}
...
let link = document.getElementById('trustindex_settings_style_booking-css');
...
if(!isCSSExists())
{
addElement('link', '<?php echo $trustindex_pm_booking->get_plugin_file_url('static/css/admin-page-settings.css'); ?>', function(success) {
loaded_count++;
if(!success)
{
not_loaded.push('CSS');
...
<?php echo TrustindexPlugin_booking::___("Widgets for Booking.com Reviews"); ?>
...
<p>
<?php echo TrustindexPlugin_booking::___("Your site cannot download our widget templates, because of your server settings not allowing that:"); ?><br /><a href="https://wordpress.org/support/article/editing-wp-config-php/#block-external-url-requests" target="_blank">https://wordpress.org/support/article/editing-wp-config-php/#block-external-url-requests</a><br /><br />
<strong><?php echo TrustindexPlugin_booking::___("Solution"); ?></strong><br />
<?php echo TrustindexPlugin_booking::___("a) You should define <strong>WP_HTTP_BLOCK_EXTERNAL</strong> as false"); ?><br />
<?php echo TrustindexPlugin_booking::___("b) or you should add Trustindex as an <strong>WP_ACCESSIBLE_HOSTS</strong>: \"*.trustindex.io\""); ?><br />
</p>
</div>
<?php endif; ?>
...
<div class="ti-box ti-notice-error">
<p>
<?php echo TrustindexPlugin_booking::___("It seems you are using a proxy for HTTP requests but after a test request it returned a following error:"); ?><br />
<strong><?php echo $proxy_check; ?></strong><br /><br />
<?php echo TrustindexPlugin_booking::___("Therefore, our plugin might not work properly. Please, contact your hosting support, they can resolve this easily."); ?>
</p>
<a href="?page=<?php echo esc_attr($_GET['page']); ?>&tab=<?php echo esc_attr($_GET['tab']); ?>&test_proxy" class="btn-text btn-refresh" data-loading-text="<?php echo TrustindexPlugin_booking::___("Loading") ;?>"><?php echo TrustindexPlugin_booking::___("Test again") ;?></a>
</div>
<?php endif; ?>
