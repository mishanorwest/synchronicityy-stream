...
$trustindex_pm_booking = new TrustindexPlugin_booking("booking", __FILE__, "9.5", "Widgets for Booking.com Reviews", "Booking.com");
...
<p>
<?php echo TrustindexPlugin_booking::___("Hello, I am happy to see that you've been using our <strong>%s</strong> plugin for a while now!", ["Widgets for Booking.com Reviews"]); ?><br>
<?php echo TrustindexPlugin_booking::___("Could you please help us and give it a 5-star rating on WordPress?"); ?><br><br>
<?php echo TrustindexPlugin_booking::___("-- Thanks, Gabor M."); ?>
</p>
<p>
...
<button class="button button-primary"><?php echo TrustindexPlugin_booking::___("Sure, you deserve it"); ?></button>
</a>
...
<button class="button button-secondary"><?php echo TrustindexPlugin_booking::___("Maybe later"); ?></button>
</a>
...
<button class="button button-secondary" style="float: right"><?php echo TrustindexPlugin_booking::___("Do not remind me again"); ?></button>
</a>
</p>
</div>
<?php
...
if(isset($_REQUEST['test']) && $token == get_option($trustindex_pm_booking->get_option_name('review-download-token')))
{
echo $token;
exit;
}
$our_token = $trustindex_pm_booking->is_review_download_in_progress();
if(
!$token
|| !$trustindex_pm_booking->is_noreg_linked()
|| $our_token != $token
) {
global $wp_query;
$wp_query->set_404();
...
{
$trustindex_pm_booking->save_details($_REQUEST['details']);
$trustindex_pm_booking->save_reviews(isset($_REQUEST['reviews']) ? $_REQUEST['reviews'] : []);
}
...
update_option($trustindex_pm_booking->get_option_name('review-download-notification'), 1, false);
try
{
$subject = 'Booking.com reviews downloaded';
$message = '
<p>Great news!</p>
<p><strong>Your reviews are downloaded <span style="color: red">from Booking.com</span>!</strong></p>
...
add_action('admin_notices', function() {
$notification = get_option('trustindex-booking-review-download-notification', 0);
if(!$notification)
{
return;
}
...
<p>
<?php echo TrustindexPlugin_booking::___('Your reviews are downloaded from %s!', [ 'Booking.com' ]); ?>
</p>
<p>
<a href="<?php echo admin_url("admin.php?page=review-widgets-for-booking-com/settings.php&review_download_notification"); ?>" style="text-decoration: none">
<button class="button button-primary"><?php echo TrustindexPlugin_booking::___("Create website widget now! »"); ?></button>
</a>
</p>
</div>
<?php
